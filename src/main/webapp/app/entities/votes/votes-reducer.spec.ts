...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VOTES_LIST actions', async () => {
    ...
    it('dispatches SEARCH_VOTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_VOTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VOTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VOTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VOTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VOTES actions', async () => {
      const expectedActions = [
        {
